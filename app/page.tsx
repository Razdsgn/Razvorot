    ...
    <div className="relative h-[1.4em] overflow-hidden">
      <AnimatePresence mode="wait">
        <motion.span
          ...
          className="absolute inset-0 font-sans text-lg text-muted md:text-xl"
        >
          {items[index]}
        </motion.span>
      </AnimatePresence>
...
const projects = [
  ...
  },
  {
    ...
    gradient: "from-[#0c0c0c] via-[#1a1a1a] to-[#333333]",
  },
];
                ...
                {experiences.map((exp, idx) => (
                  ...
                  >
                    <div className="flex items-start gap-6">
                      <span className="font-heading text-4xl font-semibold text-foreground/20">{exp.step}</span>
                      <div>
